...
(function () {
  ...
  const i18n = {
    en: {
      ...
      'mas.price.mship.note': 'Subscribe once, pick your weekly slot, and Acuity books you in automatically every week — same day, same time. Minimum 2 months · auto-renews · cancel with 1 week notice.',
      'mas.price.mship.how': '<strong>How it works:</strong> choose your service, pay your first cycle, and pick the weekday and time that suits you. From that point on, your sessions repeat automatically until you cancel.',
      ...
      'tr.pol.resched.l3': 'If Marina\'s calendar has no room left in your cycle, the session rolls automatically into the next cycle.',
      'tr.pol.resched.l4': 'If Marina has to cancel (illness, public holiday, travel), the session is rebooked and your cycle is extended by the same number of days. You never lose a session because of her.',
    ...
    pt: {
      ...
      'mas.price.mship.note': 'Assine uma vez, escolha seu horário semanal, e a Acuity reserva automaticamente toda semana — mesmo dia, mesmo horário. Mínimo de 2 meses · renovação automática · cancelamento com 1 semana de aviso.',
      'mas.price.mship.how': '<strong>Como funciona:</strong> escolha seu serviço, pague o primeiro ciclo e selecione o dia da semana e o horário que combina com você. A partir daí, as sessões se repetem automaticamente até você cancelar.',
      ...
      'tr.pol.resched.l3': 'Se a agenda da Marina não tiver vaga dentro do seu ciclo, a sessão passa automaticamente para o ciclo seguinte.',
      'tr.pol.resched.l4': 'Se a Marina precisar cancelar (doença, feriado, viagem), a sessão é reposta e o ciclo é estendido pelo mesmo número de dias. Você nunca perde sessão por causa dela.',
