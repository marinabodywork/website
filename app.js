...
(function () {
  ...
  const i18n = {
    en: {
      ...
      'mas.s.meta': '60 minutes · A$224 · Signature',
      'mas.s.badge': 'Signature',
      'mas.s.launch.badge': 'Launch price',
      'mas.s.launch.note': 'Limited launch rate. Regular price A$305 after the launch window.',
      'mas.s.p1': 'A 60-minute integrative session focused on the deep release of physical and emotional patterns stored in the nervous system. Inspired by ancient Eastern techniques, breathwork, body stimuli, and somatic awareness. The work activates the central nervous system directly.',
      ...
      'mas.choose.c3.p': 'Built for tension held by the nervous system for months or years. The 60-minute signature work.',
      ...
      'tr.pol.bill.p2': 'After your minimum, cancel anytime through the Acuity portal at least <strong>7 days before your next billing date</strong>. No message to Marina required. Unused sessions inside a paid month do not roll over. Leaving before your minimum is over works differently — see below.',
      ...
      'tr.pol.commit.p3': 'If life changes inside the minimum (pregnancy, injury, a move, anything), the remaining months of your minimum are still due — cancelling early in the portal stops the auto-charge, but it does not end your commitment. Message Marina and she will either complete your minimum in one final charge, or transfer your remaining sessions to a friend of your choice. No refunds, because the lock-in is the work. But the value never disappears.',
    ...
    pt: {
      ...
      'mas.s.name': 'Sensory Energetics',
      'mas.s.meta': '60 minutos · A$224 · Assinatura',
      'mas.s.badge': 'Assinatura',
      'mas.s.launch.badge': 'Preço de lançamento',
      'mas.s.launch.note': 'Valor de lançamento por tempo limitado. Depois volta para A$305.',
      'mas.s.p1': 'Sessão integrativa de 60 minutos focada em soltar, lá no fundo, os padrões físicos e emocionais que ficam guardados no sistema nervoso. Inspirada em técnicas ancestrais do Oriente, respiração guiada, estímulos no corpo e consciência somática. Ativa o sistema nervoso central de forma direta.',
      ...
      'mas.choose.c3.h': 'Sensory Energetics',
      'mas.choose.c3.p': 'Feito pra tensão que o seu sistema nervoso guarda há meses ou anos. O trabalho assinatura de 60 minutos.',
      ...
      'tr.plan.note': 'Como funciona: você agenda a primeira sessão na Acuity e seleciona <strong>Select and make recurring</strong> (tornar recorrente) para o seu dia e horário ficarem travados durante toda a mensalidade. Clientes Golden repetem o processo uma vez por dia de treino (2x). Clientes Diamond repetem para cada um dos 3 dias. O seu cartão é cobrado a cada 4 semanas. Cancele pelo portal a qualquer momento depois do período mínimo (2 meses no Basic e Golden, 3 meses no Diamond). Se sair antes, os meses que faltam do mínimo continuam valendo — a Marina cobra numa última cobrança ou transfere as sessões que faltam para uma amiga. Sem reembolso.',
      ...
      'tr.pol.bill.p2': 'Depois do mínimo, você cancela quando quiser pelo portal da Acuity, com no mínimo <strong>7 dias de antecedência</strong> antes da próxima cobrança. Sem precisar avisar a Marina. Sessões não utilizadas dentro de um mês pago não acumulam para o seguinte. Sair antes de fechar o mínimo funciona diferente — veja abaixo.',
      ...
      'tr.pol.commit.p3': 'Se a vida mudar dentro do mínimo (gravidez, lesão, mudança de cidade, qualquer coisa), os meses que faltam do seu mínimo continuam valendo — cancelar antes no portal para a cobrança automática, mas não encerra o seu compromisso. Fale com a Marina e ela cobra o restante numa última cobrança para fechar o mínimo, ou transfere as sessões que faltam para uma amiga da sua escolha. Sem reembolso, porque o tempo travado é parte do trabalho. Mas o valor nunca se perde.',
