...
(function () {
  ...
  const i18n = {
    en: {
      ...
      'mas.gem.h2': 'Personalised care. Priority access.',
      'mas.gem.intro': 'Buy your sessions in advance and pay less on every visit. The bigger the commitment, the lower your per-session rate.',
      'mas.gem.diamond.name': 'Diamond',
      'mas.gem.diamond.sessions': '20 sessions',
      'mas.gem.diamond.per': 'A$98 per session',
      'mas.gem.diamond.total': 'A$1,960 upfront',
      'mas.gem.diamond.worth': 'Worth A$2,500 · save A$540',
      'mas.gem.diamond.access': 'Access to all available treatments.',
      'mas.gem.diamond.meta': 'Valid 12 weeks · ideal for two sessions a week, or to split the package with someone.',
      'mas.gem.emerald.name': 'Emerald',
      'mas.gem.emerald.sessions': '10 sessions',
      'mas.gem.emerald.per': 'A$107 per session',
      'mas.gem.emerald.total': 'A$1,070 upfront',
      'mas.gem.emerald.worth': 'Worth A$1,250 · save A$180',
      'mas.gem.emerald.access': 'Choose 2 treatments from the available services.',
      'mas.gem.emerald.meta': 'Valid 12 weeks · ideal for two sessions a week, or to split the package with someone.',
    ...
    pt: {
      ...
      'mas.gem.h2': 'Cuidado personalizado. Acesso prioritário.',
      'mas.gem.intro': 'Compre suas sessões antecipadas e pague menos em cada visita. Quanto maior o compromisso, menor o valor por sessão.',
      'mas.gem.diamond.name': 'Diamond',
      'mas.gem.diamond.sessions': '20 sessões',
      'mas.gem.diamond.per': 'A$98 por sessão',
      'mas.gem.diamond.total': 'A$1.960 à vista',
      'mas.gem.diamond.worth': 'Equivale a A$2.500 · economia de A$540',
      'mas.gem.diamond.access': 'Acesso a todos os tratamentos disponíveis.',
      'mas.gem.diamond.meta': 'Válido por 12 semanas · ideal pra quem faz duas sessões por semana, ou pra dividir o pacote com alguém.',
      'mas.gem.emerald.name': 'Emerald',
      'mas.gem.emerald.sessions': '10 sessões',
      'mas.gem.emerald.per': 'A$107 por sessão',
      'mas.gem.emerald.total': 'A$1.070 à vista',
      'mas.gem.emerald.worth': 'Equivale a A$1.250 · economia de A$180',
      'mas.gem.emerald.access': 'Escolha 2 tratamentos entre os serviços disponíveis.',
      'mas.gem.emerald.meta': 'Válido por 12 semanas · ideal pra quem faz duas sessões por semana, ou pra dividir o pacote com alguém.',
