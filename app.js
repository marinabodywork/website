...
(function () {
  ...
  const i18n = {
    en: {
      ...
      'method.mod.m2.meta': '60 min · A$305 · Signature',
      ...
      'mas.s.meta': '60 minutes · A$305 · Signature',
      ...
      'mas.price.r2.sub': 'Signature · 60 min',
      ...
      'mas.price.ultimate.badge': 'Limited · May + Jun 2026',
      'mas.price.ultimate.h': 'Ultimate membership',
      'mas.price.ultimate.sub': 'Try every modality. One weekly session that rotates across the full toolkit so you experience Marina\'s whole approach inside a single membership.',
      'mas.price.ultimate.price': 'A$100/week',
      'mas.price.ultimate.meta': 'Minimum 2 months · weekly slot locked at checkout',
      'mas.price.ultimate.includes': 'Each 4-week cycle includes',
      'mas.price.ultimate.i1': 'Somatic Massage Corporal × 2',
      'mas.price.ultimate.i2': 'Somatic Massage Facial × 1',
      'mas.price.ultimate.i3': 'Sensory Energetics × 1',
      'mas.price.ultimate.note': 'Released only for sign-ups in May and June 2026. Once your weekly slot is locked, the price stays even after the window closes.',
      'mas.price.ultimate.cta': 'Message Marina to start →',
    ...
    pt: {
      ...
      'method.mod.m2.h': 'KSE Sensory Energetics',
      'method.mod.m2.meta': '60 min · A$305 · Assinatura',
      ...
      'mas.s.name': 'Sensory Energetics',
      'mas.s.meta': '60 minutos · A$305 · Assinatura',
      ...
      'mas.price.r1.price': 'A$125',
      'mas.price.r2.name': 'Sensory Energetics',
      'mas.price.r2.sub': 'Assinatura · 60 min',
      'mas.price.r2.price': 'A$305',
      ...
      'mas.price.ultimate.badge': 'Edição limitada · Maio + Junho 2026',
      'mas.price.ultimate.h': 'Plano Ultimate',
      'mas.price.ultimate.sub': 'Experimente todas as modalidades. Uma sessão semanal que vai passando por toda a caixa de ferramentas da Marina, pra você sentir o método inteiro dentro de um só plano.',
      'mas.price.ultimate.price': 'A$100/semana',
      'mas.price.ultimate.meta': 'Mínimo 2 meses · horário semanal reservado no checkout',
      'mas.price.ultimate.includes': 'A cada ciclo de 4 semanas você recebe',
      'mas.price.ultimate.i1': 'Somatic Massage Corporal × 2',
      'mas.price.ultimate.i2': 'Somatic Massage Facial × 1',
      'mas.price.ultimate.i3': 'Sensory Energetics × 1',
      'mas.price.ultimate.note': 'Disponível só pra quem entrar em maio ou junho de 2026. Depois que o seu horário semanal está travado, o preço fica o mesmo mesmo depois que a janela fechar.',
      'mas.price.ultimate.cta': 'Chamar a Marina pra começar →',
