...
(function () {
  ...
  const i18n = {
    en: {
      ...
      'tr.policy.label': 'Package policies',
      'tr.policy.h2': 'How rescheduling, renewal, and pause work.',
      'tr.policy.sub': 'Everything is self-serve through your Acuity account. You change a session, pause your cycle, or stop renewal yourself — without messaging Marina.',
      'tr.policy.slot.h': 'Your reserved slot',
      'tr.policy.slot.p': 'When you book a package, you pick your day(s) and time at checkout. Acuity reserves those slots for every week of the cycle, automatically.',
      'tr.policy.slot.l1': 'Basic — 1 slot per week, 45-day cycle.',
      'tr.policy.slot.l2': 'Golden — 2 slots per week, 2-month cycle.',
      'tr.policy.slot.l3': 'Diamond — 3 slots per week, 3-month cycle.',
      'tr.policy.resch.h': 'Rescheduling a session',
      'tr.policy.resch.p': 'You reschedule any session yourself through your Acuity portal, with at least 72 hours’ notice. Pick any open slot in Marina’s calendar — no approval needed.',
      'tr.policy.resch.l1': '72+ hours’ notice — free, no penalty.',
      'tr.policy.resch.l2': 'Less than 72 hours’ notice — the session counts as used.',
      'tr.policy.resch.l3': 'No-show without notice — the session counts as used.',
      'tr.policy.resch.l4': 'If Marina’s calendar has no open slot in your cycle, the session rolls to the next cycle automatically.',
      'tr.policy.marina.h': 'If Marina has to cancel',
      'tr.policy.marina.p': 'If Marina cancels a session (illness, public holiday, travel), the session is restored and your cycle is extended by the same number of days. You never lose a session because of her schedule.',
      'tr.policy.freeze.h': 'Freeze for emergencies',
      'tr.policy.freeze.p': 'Each package includes one freeze per cycle for serious situations — surgery, family emergency, illness. You activate it yourself in your portal. No medical proof required.',
      'tr.policy.freeze.l1': 'Basic — freeze up to 1 week.',
      'tr.policy.freeze.l2': 'Golden — freeze up to 2 weeks.',
      'tr.policy.freeze.l3': 'Diamond — freeze up to 3 weeks.',
      'tr.policy.renew.h': 'Automatic renewal',
      'tr.policy.renew.p': 'At the end of your cycle, your package renews automatically and your card is charged for the next cycle. To stop renewal, cancel through your portal at least 7 days before your cycle ends. Unused sessions do not carry over.',
      'tr.policy.single.h': 'Single sessions',
      'tr.policy.single.p': 'No cycle, no reserved slot. The 72-hour reschedule rule still applies. Freeze does not apply to single sessions.',
    ...
    pt: {
      ...
      'tr.policy.label': 'Política dos pacotes',
      'tr.policy.h2': 'Como funciona reagendar, renovar e pausar.',
      'tr.policy.sub': 'Tudo é autoatendimento pela sua conta no Acuity. Você reagenda uma sessão, pausa o ciclo ou cancela a renovação sozinha — sem precisar mandar mensagem para a Marina.',
      'tr.policy.slot.h': 'Seu horário reservado',
      'tr.policy.slot.p': 'Quando você compra um pacote, escolhe o(s) dia(s) e horário no checkout. A Acuity reserva esses horários em todas as semanas do ciclo, automaticamente.',
      'tr.policy.slot.l1': 'Basic — 1 horário por semana, ciclo de 45 dias.',
      'tr.policy.slot.l2': 'Golden — 2 horários por semana, ciclo de 2 meses.',
      'tr.policy.slot.l3': 'Diamond — 3 horários por semana, ciclo de 3 meses.',
      'tr.policy.resch.h': 'Reagendar uma sessão',
      'tr.policy.resch.p': 'Você reagenda qualquer sessão pela sua conta no Acuity, com no mínimo 72 horas de antecedência. Escolhe um horário aberto na agenda da Marina — sem precisar de aprovação.',
      'tr.policy.resch.l1': '72h ou mais de antecedência — livre, sem penalidade.',
      'tr.policy.resch.l2': 'Menos de 72h de antecedência — a sessão conta como utilizada.',
      'tr.policy.resch.l3': 'Falta sem aviso — a sessão conta como utilizada.',
      'tr.policy.resch.l4': 'Se a agenda da Marina não tiver horário aberto dentro do ciclo, a sessão rola automaticamente para o ciclo seguinte.',
      'tr.policy.marina.h': 'Se a Marina precisar cancelar',
      'tr.policy.marina.p': 'Se a Marina cancelar uma sessão (doença, feriado, viagem), a sessão é reposta e o seu ciclo é estendido pelo mesmo número de dias. Você nunca perde sessão por causa da agenda dela.',
      'tr.policy.freeze.h': 'Pausa para emergências',
      'tr.policy.freeze.p': 'Cada pacote inclui uma pausa por ciclo para situações sérias — cirurgia, emergência familiar, doença. Você aciona sozinha pelo portal. Sem necessidade de atestado.',
      'tr.policy.freeze.l1': 'Basic — pausa de até 1 semana.',
      'tr.policy.freeze.l2': 'Golden — pausa de até 2 semanas.',
      'tr.policy.freeze.l3': 'Diamond — pausa de até 3 semanas.',
      'tr.policy.renew.h': 'Renovação automática',
      'tr.policy.renew.p': 'No fim do seu ciclo, o pacote renova automaticamente e a cobrança é feita no cartão para o próximo ciclo. Para parar a renovação, cancele pelo portal com no mínimo 7 dias de antecedência antes do fim do ciclo. Sessões não utilizadas não acumulam.',
      'tr.policy.single.h': 'Sessões avulsas',
      'tr.policy.single.p': 'Sem ciclo, sem horário reservado. A regra de 72h para reagendar continua valendo. A pausa não se aplica a sessões avulsas.',
