...
(function () {
  ...
  const i18n = {
    ...
    pt: {
      ...
      'tr.plan.note': 'Como funciona: você agenda a primeira sessão na Acuity e seleciona <strong>Select and make recurring</strong> (tornar recorrente) para o seu dia e horário ficarem travados durante toda a mensalidade. Clientes Golden repetem o processo uma vez por dia de treino (2x). Clientes Diamond repetem para cada um dos 3 dias. O seu cartão é cobrado a cada 4 semanas. Cancele pelo portal a qualquer momento depois do período mínimo (2 meses no Basic e Golden, 3 meses no Diamond). Para sair antes, fale com a Marina — não é um cancelamento pelo portal — e os meses que faltam continuam valendo: uma última cobrança ou as sessões transferidas para uma amiga. Sem reembolso.',
      ...
      'tr.pol.commit.p3': 'Se a vida mudar dentro do mínimo (gravidez, lesão, mudança de cidade, qualquer coisa), fale direto com a Marina — sair dentro do mínimo não é um cancelamento pelo portal, e os meses que faltam continuam valendo. Ela cobra o restante numa última cobrança para fechar o mínimo, ou transfere as sessões que faltam para uma amiga da sua escolha. Sem reembolso, porque o tempo travado é parte do trabalho. Mas o valor nunca se perde.',
