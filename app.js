...
(function () {
  ...
  const i18n = {
    en: {
      ...
      'mas.gem.intro': 'Commit to a rhythm and every session costs less than a single booking.',
      'mas.gem.emerald.name': 'Emerald',
      'mas.gem.emerald.tagline': 'Focus. Consistency. Lasting results.',
      ...
      'mas.gem.diamond.weekly': 'A$178 per week',
      'mas.gem.diamond.total': 'A$1,780 total',
      'mas.gem.diamond.worth': 'Worth A$2,500 · save A$720 vs single sessions',
      'mas.gem.diamond.who': 'Up to 2 people on the same plan',
      'mas.gem.diamond.services': 'All 5 services, including Sensory Energetics',
    ...
    pt: {
      ...
      'mas.gem.intro': 'Assuma um ritmo e cada sessão sai por menos do que uma sessão avulsa.',
      'mas.gem.emerald.name': 'Emerald',
      'mas.gem.emerald.tagline': 'Foco. Consistência. Resultado que dura.',
      ...
      'mas.gem.emerald.weekly': 'A$107 por semana',
      'mas.gem.emerald.total': 'A$1.070 no total',
      'mas.gem.emerald.worth': 'Equivale a A$1.250 · economia de A$180 vs sessões avulsas',
      'mas.gem.emerald.who': 'Individual (1 pessoa)',
      'mas.gem.emerald.services': 'Escolha até 2 serviços (Sensory Energetics não incluído)',
      'mas.gem.emerald.freeze': 'Congele por até 2 semanas',
      'mas.gem.emerald.valid': 'Válido por até 12 semanas',
      'mas.gem.diamond.name': 'Diamond',
      'mas.gem.diamond.tagline': 'Mais liberdade. Uma jornada mais completa.',
      ...
      'mas.gem.diamond.weekly': 'A$178 por semana',
      'mas.gem.diamond.total': 'A$1.780 no total',
      ...
      'mas.gem.diamond.services': 'Todos os 5 serviços, incluindo Sensory Energetics',
