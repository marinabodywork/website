...
(function () {
  ...
  const i18n = {
    en: {
      ...
      'home.svc.s3.meta': '60 min · Monthly plans · From A$75/session',
      ...
      'tr.plan.basic.f3': 'Transferable to a friend if you stop early',
      ...
      'tr.plan.golden.f3': 'Transferable to a friend if you stop early',
      ...
      'tr.plan.diamond.f3': 'Transferable to a friend if you stop early',
    ...
    pt: {
      ...
      'home.svc.s3.meta': '60 min · Planos mensais · A partir de A$75/sessão',
      ...
      'tr.plan.basic.f3': 'Transferível pra uma amiga se você precisar parar antes',
      ...
      'tr.plan.golden.f3': 'Transferível pra uma amiga se você precisar parar antes',
      ...
      'tr.plan.diamond.f3': 'Transferível pra uma amiga se você precisar parar antes',
