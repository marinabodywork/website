...
const p=await b.newPage({viewport:{width:1200,height:760},deviceScaleFactor:1.1});
...
const el=await p.$('.borders-card'); await el.scrollIntoViewIfNeeded(); await el.screenshot({path:`${out}/home-borders-card.png`});
